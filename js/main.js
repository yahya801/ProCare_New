(function ($) {
  ...
  (function () {
    ...
    map.addMarker({
      ...
      infoWindow: {
        content:
          '<div class="map-info">601 Pompton Ave<br> Cedar Grove, NJ 07009</div>',
      },
    });
    var styles = [
      { featureType: "road", stylers: [{ color: "#422B53" }] },
      { featureType: "landscape", stylers: [{ color: "#2D1C3A" }] },
      { featureType: "water", stylers: [{ color: "#78588C" }] },
      { elementType: "labels.text.fill", stylers: [{ color: "#808080" }] },
      { featureType: "poi", stylers: [{ color: "#1D1026" }] },
      {
        elementType: "labels.text",
        stylers: [{ saturation: 1 }, { weight: 0.1 }, { color: "#cccccc" }],
      },
    ];
    map.addStyle({
